...
public class SevenTaskThreeDevice {
    public static void main(String[] args) throws Exception {
        CloudSim.init(1, Calendar.getInstance(), false);

        // Parse topology
        var topologyParser = new Parser(new File("src/main/resources/seven_task_three_device/topology.json"));
        ...
        // Parse workflows
        var workflowParser = new misty.parse.workflow.Parser(new File("src/main/resources/seven_task_three_device/workflows.json"));
