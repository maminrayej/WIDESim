...
public class TwoTaskOneDevice {
    public static void main(String[] args) throws Exception {
        ...
        // Parse topology
        var topologyParser = new Parser(new File("/home/amin/projects/java/Misty/src/main/resources/two_task_one_device/topology.json"));
        ...
        // Parse workflows
        var workflowParser = new misty.parse.workflow.Parser(new File("/home/amin/projects/java/Misty/src/main/resources/two_task_one_device/workflows.json"));
