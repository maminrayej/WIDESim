...
public class Epigenomics46 {
    public static void main(String[] args) throws Exception {
        ...
        // Parse topology
        var topologyParser = new Parser(new File("src/main/resources/topologies/new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_new_topology.json"));
