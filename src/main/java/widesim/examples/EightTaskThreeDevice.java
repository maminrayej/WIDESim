...
public class EightTaskThreeDevice {
    public static void main(String[] args) throws Exception {
        ...
        // Parse topology
        var topologyParser = new Parser(new File("src/main/resources/eight_task_three_device/topology.json"));
        ...
        // Parse workflows
        var workflowParser = new widesim.parse.workflow.Parser(new File("src/main/resources/eight_task_three_device/workflows.json"));
