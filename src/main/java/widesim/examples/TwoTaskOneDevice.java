...
public class TwoTaskOneDevice {
    public static void main(String[] args) throws Exception {
        ...
        // Parse topology
        var topologyParser = new Parser(new File("src/main/resources/two_task_one_device/topology.json"));
        ...
        // Parse workflows
        var workflowParser = new widesim.parse.workflow.Parser(new File("src/main/resources/two_task_one_device/workflows.json"));
